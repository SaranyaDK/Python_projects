...
class Calculator:
    def __init__(self, heading):
        heading.title("Virtual Calculator")
        heading.geometry('357x420+0+0')
        heading.config(bg='orange')
        heading.resizable(False, False)

        self.equation = StringVar()
        self.entry_value = ' '
        Entry(width=17, bg='orange', font=('Arial Bold',30), textvariable=self.equation).place(x=0,y=0)
